...
var Icon$M = function (props) {
    return (React__default['default'].createElement("svg", __assign({ id: "Icons", height: "512", viewBox: "0 0 60 60", width: "512", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__default['default'].createElement("path", { d: "m58 57v-29a1 1 0 0 0 -1-1h-54a1 1 0 0 0 -1 1v29z", fill: "#cad0d7" }),
        React__default['default'].createElement("path", { d: "m45 13a1 1 0 0 1 1 1v41h-32v-41a1 1 0 0 1 1-1z", fill: "#e4e8eb" }),
        React__default['default'].createElement("path", { d: "m19 40h22v16h-22z", fill: "#cad0d7" }),
        React__default['default'].createElement("path", { d: "m23 41h14v14h-14z", fill: "#4fc0e8" }),
        React__default['default'].createElement("path", { d: "m37 51c-5-1-7-8-7-8v12h7z", fill: "#66d4f1" }),
        React__default['default'].createElement("path", { d: "m30 51c-5-1-7-8-7-8v12h7z", fill: "#66d4f1" }),
        React__default['default'].createElement("rect", { fill: "#3aadd9", height: "4", rx: "1", width: "4", x: "6", y: "31" }),
        React__default['default'].createElement("rect", { fill: "#4fc0e8", height: "4", rx: "1", width: "5", x: "18", y: "24" }),
        React__default['default'].createElement("rect", { fill: "#4fc0e8", height: "4", rx: "1", width: "6", x: "27", y: "24" }),
        React__default['default'].createElement("rect", { fill: "#4fc0e8", height: "4", rx: "1", width: "5", x: "37", y: "24" }),
        React__default['default'].createElement("g", { fill: "#3aadd9" },
            React__default['default'].createElement("rect", { height: "4", rx: "1", width: "4", x: "6", y: "47" }),
            React__default['default'].createElement("rect", { height: "4", rx: "1", width: "4", x: "6", y: "39" }),
            React__default['default'].createElement("rect", { height: "4", rx: "1", transform: "matrix(-1 0 0 -1 104 66)", width: "4", x: "50", y: "31" }),
            React__default['default'].createElement("rect", { height: "4", rx: "1", transform: "matrix(-1 0 0 -1 104 98)", width: "4", x: "50", y: "47" }),
            React__default['default'].createElement("rect", { height: "4", rx: "1", transform: "matrix(-1 0 0 -1 104 82)", width: "4", x: "50", y: "39" })),
        React__default['default'].createElement("rect", { fill: "#f76c82", height: "18", rx: "2", width: "24", x: "18", y: "1" }),
        React__default['default'].createElement("path", { d: "m35 9v2a1 1 0 0 1 -1 1h-2v2a1 1 0 0 1 -1 1h-2a1 1 0 0 1 -1-1v-2h-2a1 1 0 0 1 -1-1v-2a1 1 0 0 1 1-1h2v-2a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v2h2a1 1 0 0 1 1 1z", fill: "#fff" }),
        React__default['default'].createElement("rect", { fill: "#a9b0bb", height: "8", rx: "1", width: "24", x: "18", y: "33" }),
        React__default['default'].createElement("rect", { fill: "#636c77", height: "4", rx: "1", width: "58", x: "1", y: "55" }),
        React__default['default'].createElement("path", { d: "m29 41h2v14h-2z", fill: "#3aadd9" })));
};
...
var Icon$O = function (props) {
    return (React__default['default'].createElement("svg", __assign({ height: "512", viewBox: "0 0 56 58", width: "512", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__default['default'].createElement("g", { id: "Page-1", fill: "none" },
            React__default['default'].createElement("g", { id: "056---Heartbeat" },
                React__default['default'].createElement("path", { id: "Shape", d: "m19.5 12.13c-.5398049.1018455-1.0738766.2320254-1.6.39", fill: "#fb7b76" }),
                React__default['default'].createElement("path", { id: "Shape", d: "m48.3 12.45c-1.03-.38-2.4.75-3.06 2.52s-.34 3.5.67 3.89c-5.5-1.74-8.68-.8-10.26.11 5.9-.61 11.68 10.22 9.71 22.03-2 12-5 22.58-23 13.58-13.96-6.98-17.09-22.73-12.19-31.31 1.3288462-2.4712439 3.5384139-4.3524107 6.19-5.27 1.6462885-.5859142 3.3985255-.8143186 5.14-.67 1.1666846.1126567 2.3042258.4308974 3.36.94 4.67 2.58 6.51 8.8 6.53 8.87.1197007.4299294.5137516.7254676.96.72.0948095.0007585.1891953-.0127252.28-.04.2537084-.072279.4681275-.2427316.5957634-.4736024.1276358-.2308707.1579531-.5031032.0842366-.7563976-.09-.29-2-6.84-7.18-9.9.7641326-.8656364 1.5968318-1.668238 2.49-2.4.17-.14.35-.28.53-.42 2.049256-1.6144922 4.4344205-2.7489831 6.98-3.32.33-.08.66-.14 1.01-.19 2.6974318-.37636718 5.4456421-.1090849 8.02.78 1.0790228.354663 2.1288504.7926484 3.14 1.31z", fill: "#fb7b76" }),
                React__default['default'].createElement("path", { id: "Shape", d: "m35.65 18.97c-.4907617.2594376-.9283645.6088414-1.29 1.03", fill: "#fb7b76" }),
                React__default['default'].createElement("path", { id: "Shape", d: "m49 16.35c-.65 1.75-1.99 2.86-3.02 2.53-.0172822.0015564-.0346458-.0019163-.05-.01-.01 0-.01-.01-.02-.01-1.01-.39-1.32-2.13-.67-3.89s2.03-2.9 3.06-2.52 1.35 2.13.7 3.9z", fill: "#ff5364" }),
                React__default['default'].createElement("path", { id: "Shape", d: "m26.05 9.19c-1.0929419.9875319-2.0094195 2.1542654-2.71 3.45-.8129937 1.4774554-1.4314584 3.0538683-1.84 4.69-1.7414745-.1443186-3.4937115.0840858-5.14.67-2.6515861.9175893-4.8611538 2.7987561-6.19 5.27-.44-7.15 4.58-9.8 7.73-10.75-.59-.83-1.54-3.02-1.54-8.52 0 1.1 2.02 2 4.5 2s4.5-.9 4.5-2c-.030981 1.75477949.2016102 3.50426981.69 5.19z", fill: "#df4d60" }),
                React__default['default'].createElement("ellipse", { id: "Oval", cx: "20.86", cy: "4", fill: "#802d40", rx: "4.5", ry: "2" }),
                React__default['default'].createElement("g", { fill: "#fb7b76" },
                    React__default['default'].createElement("path", { id: "Shape", d: "m34.86 2.5v3.17c-.8409983.05886503-1.6765623.17918625-2.5.36-.8540537.18380651-1.69053.44144122-2.5.77v-4.3c0-1.38071187 1.1192881-2.5 2.5-2.5s2.5 1.11928813 2.5 2.5z" }),
                    React__default['default'].createElement("path", { id: "Shape", d: "m42.23 3.29-1.2 3.09-.02.02-.01.02c-1.595573-.57584525-3.2841784-.85049792-4.98-.81l1.47-3.9c.4730171-1.25779546 1.8557302-1.91665467 3.1305694-1.49170824 1.2748393.42494642 1.9856942 1.78166161 1.6094306 3.07170824z" }),
                    React__default['default'].createElement("path", { id: "Shape", d: "m36.02 5.61-.01.03" }),
                    React__default['default'].createElement("path", { id: "Shape", d: "m46.75 8.58-2 1.33c-.08-.19-.17-.38-.27-.57-.7625978-1.36721268-2.0011231-2.40643503-3.48-2.92l.01-.02.02-.02 2.94-1.96c1.1487523-.7676758 2.7023242-.45875228 3.47.69s.4587523 2.7023242-.69 3.47z" })),
                React__default['default'].createElement("path", { id: "Shape", d: "m45.16 11.14c-2.5743579-.8890849-5.3225682-1.15636718-8.02-.78-.34.05-.68.11-1.01.19-2.5455795.5710169-4.930744 1.7055078-6.98 3.32-.18.14-.36.28-.53.42-.8931682.731762-1.7258674 1.5343636-2.49 2.4 5.18 3.06 7.09 9.61 7.18 9.9.0737165.2532944.0433992.5255269-.0842366.7563976-.1276359.2308708-.342055.4013234-.5957634.4736024-.0908047.0272748-.1851905.0407585-.28.04-.4462484.0054676-.8402993-.2900706-.96-.72-.148964-.5041164-.3310261-.9978554-.545-1.478-.4710986-1.1328366-1.0469306-2.2192173-1.72-3.245-.8254328-1.2864621-1.8623712-2.4241529-3.067-3.365-1.3293156-.9872824-2.9079468-1.5836849-4.558-1.722.4085416-1.6361317 1.0270063-3.2125446 1.84-4.69 1.429696-2.64436305 3.7347583-4.70902013 6.52-5.84.80947-.32855878 1.6459463-.58619349 2.5-.77.8234377-.18081375 1.6590017-.30113497 2.5-.36.3853576-.04019133.7725522-.06021863 1.16-.06 1.6958216-.04049792 3.384427.23415475 4.98.81 1.4788769.51356497 2.7174022 1.55278732 3.48 2.92.1.19.19.38.27.57.1664821.3994518.3035146.8105493.41 1.23z", fill: "#ff5364" }),
                React__default['default'].createElement("path", { id: "Shape", d: "m28 51c-.4176605-.0013517-.7904909-.2621337-.935-.654l-6.1-16.558-3.033 7.583c-.1522144.3810076-.5217146.6303806-.932.629h-16c-.55228475 0-1-.4477153-1-1s.44771525-1 1-1h15.323l3.748-9.371c.1535278-.3844959.5281139-.6346264.9420911-.629083.4139772.0055433.7817314.2656141.9249089.654083l6.07 16.476 5.055-13.482c.1437021-.3824194.505572-.6389749.914-.648.40525.001215.7728871.2377204.942.606l2.74 6.394h17.341c.5522847 0 1 .4477153 1 1s-.4477153 1-1 1h-18c-.3999561-.0000442-.7614173-.2383962-.919-.606l-2.019-4.711-5.125 13.669c-.1467373.3901885-.5201322.6484168-.937.648z", fill: "#f3d55b" })))));
};
...
var Icon$R = function (props) {
    return (React__default['default'].createElement("svg", __assign({ id: "Layer_1", height: "512", viewBox: "0 0 68 68", width: "512", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("g", null,
                React__default['default'].createElement("g", null,
                    React__default['default'].createElement("path", { d: "m3.69 64.88c-.38 0-.77-.15-1.06-.44-.59-.59-.59-1.54 0-2.12l5.92-5.92c.59-.59 1.54-.59 2.12 0 .59.59.59 1.54 0 2.12l-5.92 5.92c-.29.3-.68.44-1.06.44z", fill: "#dfe9f4" }))),
            React__default['default'].createElement("g", null,
                React__default['default'].createElement("g", null,
                    React__default['default'].createElement("path", { d: "m55.27 26.11-31.56 31.56c-1.21 1.2-3.16 1.2-4.36 0l-9.95-9.95c-1.21-1.2-1.21-3.15 0-4.36l31.56-31.56z", fill: "#e3dfee" })),
                React__default['default'].createElement("g", null,
                    React__default['default'].createElement("path", { d: "m22.21 30.55-12.81 12.81c-1.2 1.2-1.2 3.15 0 4.36l9.95 9.95c1.2 1.2 3.15 1.2 4.36 0l17.41-17.41z", fill: "#f34c6e" })),
                React__default['default'].createElement("g", null,
                    React__default['default'].createElement("path", { d: "m15.05 58.34 2.48-2.48-6.32-6.32-2.48 2.48c-1.75 1.75-1.75 4.57 0 6.32 1.75 1.74 4.58 1.74 6.32 0z", fill: "#e3dfee" })),
                React__default['default'].createElement("g", { opacity: ".1" },
                    React__default['default'].createElement("path", { d: "m17.53 55.86-2.48 2.48c-.87.87-2.02 1.3-3.16 1.3s-2.29-.43-3.16-1.3c-1.16-1.17-1.55-2.82-1.15-4.31.18.74.57 1.43 1.15 2.01.87.88 2.02 1.31 3.16 1.31s2.29-.43 3.16-1.31l1.33-1.33z", fill: "#070707" })),
                React__default['default'].createElement("g", null,
                    React__default['default'].createElement("path", { d: "m61.68 10.6-9.54 9.55-1.42 1.41-5.21-5.21 1.42-1.41 9.54-9.55z", fill: "#e3dfee" })),
                React__default['default'].createElement("g", null,
                    React__default['default'].createElement("g", null,
                        React__default['default'].createElement("path", { d: "m50.79 30.59-1.41 1.41h-.01l-5.63-5.63c-.39-.39-.39-1.02 0-1.41s1.02-.39 1.42 0z", fill: "#0e4a77" }))),
                React__default['default'].createElement("g", null,
                    React__default['default'].createElement("g", null,
                        React__default['default'].createElement("path", { d: "m46.12 35.26-1.42 1.42-3.44-3.45c-.39-.39-.39-1.02 0-1.41s1.02-.39 1.41 0z", fill: "#0e4a77" }))),
                React__default['default'].createElement("g", null,
                    React__default['default'].createElement("g", null,
                        React__default['default'].createElement("path", { d: "m41.44 39.94-1.41 1.41-5.64-5.63c-.39-.39-.39-1.03 0-1.42s1.03-.39 1.42 0z", fill: "#0e4a77" }))),
                React__default['default'].createElement("g", null,
                    React__default['default'].createElement("g", null,
                        React__default['default'].createElement("path", { d: "m36.77 44.61-1.41 1.41h-.01l-3.44-3.44c-.39-.39-.39-1.02 0-1.42.39-.39 1.02-.39 1.41 0z", fill: "#0e4a77" }))),
                React__default['default'].createElement("g", null,
                    React__default['default'].createElement("g", null,
                        React__default['default'].createElement("path", { d: "m32.09 49.28v.01l-1.41 1.41-5.63-5.64c-.39-.39-.39-1.02 0-1.41s1.02-.39 1.41 0z", fill: "#0e4a77" }))),
                React__default['default'].createElement("g", null,
                    React__default['default'].createElement("g", null,
                        React__default['default'].createElement("path", { d: "m27.42 53.96-1.41 1.41-3.45-3.44c-.39-.39-.39-1.03 0-1.42s1.03-.39 1.42 0z", fill: "#0e4a77" })))),
            React__default['default'].createElement("g", null,
                React__default['default'].createElement("path", { d: "m63.88 50.79v13.26c0 1.49-1.2 2.69-2.69 2.69h-11.06c-1.49 0-2.7-1.2-2.7-2.69v-13.25c0-1.49 1.22-2.7 2.71-2.7.74 0 1.41-.3 1.91-.8.45-.45.75-1.08.78-1.78v-2.05h5.66v2.05c.07 1.44 1.24 2.58 2.69 2.58h.01c1.49 0 2.69 1.2 2.69 2.69z", fill: "#dfe9f4" })),
            React__default['default'].createElement("g", null,
                React__default['default'].createElement("path", { d: "m47.42 56.36v7.69c0 1.49 1.21 2.69 2.7 2.69h11.06c1.49 0 2.69-1.2 2.69-2.69v-7.69c-5.71-1.58-9.53 2.21-16.45 0z", fill: "#f34c6e" })),
            React__default['default'].createElement("g", { opacity: ".1" },
                React__default['default'].createElement("path", { d: "m61.18 48.1h-.01c-.06 0-.12-.01-.18-.02v2.24c0 7.49-6.08 13.57-13.57 13.57v.16c0 1.49 1.2 2.69 2.69 2.69h11.07c1.49 0 2.69-1.2 2.69-2.69v-13.26c0-1.49-1.2-2.69-2.69-2.69z", fill: "#070707" })),
            React__default['default'].createElement("g", { opacity: ".1" },
                React__default['default'].createElement("path", { d: "m52.82 43.47h5.66v1.21h-5.66z", fill: "#070707" })),
            React__default['default'].createElement("g", null,
                React__default['default'].createElement("path", { d: "m60.9 40.48v2.04c0 .55-.45 1-1 1h-8.5c-.55 0-1-.45-1-1v-2.04c0-.55.45-1 1-1h8.5c.56 0 1 .45 1 1z", fill: "#0e4a77" })),
            React__default['default'].createElement("g", { opacity: ".1" },
                React__default['default'].createElement("path", { d: "m60.9 40.48v2.04c0 .55-.45 1-1 1h-8.51c-.55 0-1-.45-1-1v-.13h8.38c.55 0 1-.45 1-1v-1.91h.13c.55 0 1 .45 1 1z", fill: "#070707" })),
            React__default['default'].createElement("g", null,
                React__default['default'].createElement("path", { d: "m54.34 53.02v7.77c0 .65-.52 1.17-1.17 1.17h-5.74v-10.1h5.74c.65-.01 1.17.51 1.17 1.16z", fill: "#1ec5e0" })),
            React__default['default'].createElement("g", { opacity: ".1" },
                React__default['default'].createElement("path", { d: "m53.17 51.85h-.54v3.45c0 2.87-2.33 5.2-5.2 5.2v1.45h5.74c.64 0 1.17-.52 1.17-1.17v-7.77c0-.63-.53-1.16-1.17-1.16z", fill: "#070707" })),
            React__default['default'].createElement("g", null,
                React__default['default'].createElement("g", null,
                    React__default['default'].createElement("g", null,
                        React__default['default'].createElement("path", { d: "m64.81 14.73c-.26 0-.51-.1-.71-.29l-11.46-11.47c-.39-.39-.39-1.02 0-1.41s1.02-.39 1.41 0l11.46 11.46c.39.39.39 1.02 0 1.41-.19.2-.44.3-.7.3z", fill: "#0e4a77" })))),
            React__default['default'].createElement("g", { opacity: ".1" },
                React__default['default'].createElement("path", { d: "m55.27 26.11-31.56 31.56c-1.21 1.2-3.16 1.2-4.36 0l-9.95-9.95c-1.21-1.2-1.21-3.15 0-4.36l.14-.13 9.81 9.81c1.2 1.2 3.15 1.2 4.36 0l29.25-29.24z", fill: "#070707" })),
            React__default['default'].createElement("g", { opacity: ".1" },
                React__default['default'].createElement("path", { d: "m52.14 20.15-1.42 1.41-5.21-5.21 1.42-1.41z", fill: "#070707" })),
            React__default['default'].createElement("g", null,
                React__default['default'].createElement("g", null,
                    React__default['default'].createElement("path", { d: "m55.9 27.74c-.26 0-.51-.1-.71-.29l-15.56-15.58c-.39-.39-.39-1.02 0-1.41s1.02-.39 1.41 0l15.57 15.57c.39.39.39 1.02 0 1.41-.19.2-.45.3-.71.3z", fill: "#0e4a77" }))))));
};
...
var Icon$X = function (props) {
    return (React__default['default'].createElement("svg", __assign({ id: "Capa_1", height: "512", viewBox: "0 0 512 512", width: "512", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("path", { d: "m0 315.03c0-146.354 118.643-264.996 264.996-264.996h55.004v-35.005c0-12.987 15.382-19.837 25.034-11.149l100 90c6.621 5.959 6.621 16.34 0 22.299l-100 90c-9.652 8.688-25.034 1.837-25.034-11.149v-34.996h-51.157c-105.164 0-199.931 63.465-239.973 160.707-6.256 15.193-28.87 10.72-28.87-5.711z", fill: "#44ffe8" }),
            React__default['default'].createElement("path", { d: "m264.232 105.034c-129.006 0-237.313 96.807-251.969 224.738 6.391 1.192 13.508-1.502 16.608-9.031 40.042-97.242 134.809-160.707 239.973-160.707h51.156v34.996c0 12.987 15.382 19.837 25.034 11.149l100-90c3.309-2.978 4.964-7.062 4.965-11.145z", fill: "#00c6cb" }),
            React__default['default'].createElement("g", null,
                React__default['default'].createElement("path", { d: "m512 196.97c0 146.353-118.643 264.996-264.996 264.996h-55.004v35.004c0 12.987-15.382 19.837-25.034 11.149l-100-90c-6.621-5.959-6.621-16.34 0-22.299l100-90c9.653-8.688 25.034-1.837 25.034 11.149v34.996h51.157c105.164 0 199.931-63.465 239.973-160.707 6.256-15.192 28.87-10.719 28.87 5.712z", fill: "#ff6c6c" })),
            React__default['default'].createElement("path", { d: "m499.738 182.228c-14.657 127.931-122.964 224.738-251.969 224.738h-185.769c-.001 4.086 1.654 8.173 4.965 11.153l100 90c9.653 8.688 25.034 1.837 25.034-11.149v-35.004h55.004c146.354 0 264.997-118.642 264.997-264.995 0-8.289-5.756-13.53-12.262-14.743z", fill: "#ff1f3e" }))));
};
...
var Icon$16 = function (props) {
    return (React__default['default'].createElement("svg", __assign({ id: "Layer_1", height: "512", viewBox: "0 0 468 468", width: "512", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("g", null,
                React__default['default'].createElement("path", { d: "m423.091 5.997c-12.953-10.088-31.769-7.125-40.968 6.458-34.44 50.854-71.716 105.327-105.02 154.731l23.921 18.631c40.174-44.005 84.315-93.074 125.629-138.534 11.07-12.179 9.428-31.169-3.562-41.286z", fill: "#b76c4f" }),
                React__default['default'].createElement("path", { d: "m423.091 5.997c-6.409-4.991-14.253-6.783-21.657-5.678 14.793 9.237 17.649 30.035 5.833 42.877-39.313 43.258-81.178 89.774-119.757 132.095l13.515 10.526c40.174-44.005 84.315-93.074 125.629-138.534 11.069-12.179 9.427-31.169-3.563-41.286z", fill: "#ad6149" })),
            React__default['default'].createElement("g", null,
                React__default['default'].createElement("path", { d: "m34 272.418v6.413c0 104.475 84.943 189.169 189.726 189.169 104.783 0 189.726-84.694 189.726-189.169v-6.413z", fill: "#ffb966" }),
                React__default['default'].createElement("path", { d: "m223.726 447.563c-100.052 0-182.009-77.22-189.207-175.146h-.519v6.413c0 104.476 84.943 189.17 189.726 189.17 104.783 0 189.726-84.694 189.726-189.17v-6.413h-.52c-7.197 97.927-89.154 175.146-189.206 175.146z", fill: "#f2a85f" })),
            React__default['default'].createElement("g", null,
                React__default['default'].createElement("g", null,
                    React__default['default'].createElement("path", { d: "m223.813 354.528c102.168 0 185.462-35.511 189.578-79.997-.196-5.438-.376-9.973-.388-11.729 0-33.937-22.248-62.5-52.521-71.079 2.241-46.494-40.287-84.077-84.365-75.151-6.897-53.929-54.706-79.391-103.891-73.407-.757 94.237-73.752 77.732-90.969 138.743-27.229 10.418-46.634 37.437-46.634 69.136-.036 5.037-.563 20.036-.563 20.036.001 46.087 84.956 83.448 189.753 83.448z", fill: "#ededed" }),
                    React__default['default'].createElement("path", { d: "m412.879 258.673c-8.097 42.806-89.638 76.44-189.066 76.44-100.521 0-182.772-34.376-189.318-77.854-.167 6.201-.434 13.821-.434 13.821 0 46.087 84.955 83.448 189.752 83.448 102.168 0 185.462-35.511 189.578-79.997-.196-5.438-.376-9.973-.389-11.729.001-1.387-.05-2.761-.123-4.129z", fill: "#e0e0e0" })),
                React__default['default'].createElement("g", { fill: "#e0e0e0" },
                    React__default['default'].createElement("g", null,
                        React__default['default'].createElement("path", { d: "m83.25 185.726c30.003 1.37 54.335 30.251 50.36 60.08-.312 2.805 1.705 5.332 4.506 5.644 2.75.32 5.335-1.698 5.635-4.512 4.762-35.651-24.497-70.114-60.366-71.444-.778 2.043-1.495 4.17-2.128 6.413-2.405.921-4.745 1.977-7.02 3.147.184.034 9.013.672 9.013.672z" }),
                        React__default['default'].createElement("path", { d: "m273.041 115.175c-8.23 24.044-37.118 37.194-60.677 27.762-2.639-.995-5.579.345-6.569 2.988-.99 2.641.346 5.587 2.984 6.578 29.936 12.045 66.176-6.042 75.016-37.019-2.548.212-5.11.567-7.677 1.087-.276-2.16-.625-4.269-1.03-6.338-.689.757-1.644 3.983-2.047 4.942z" }),
                        React__default['default'].createElement("path", { d: "m291.006 215.295-3.884-1.353c-2.664-.925-5.57.481-6.495 3.147-.926 2.664.481 5.577 3.142 6.504 30.731 12.777 67.648.654 83.648-29.486-2.261-.908-4.57-1.713-6.936-2.384.103-2.142.11-4.265.027-6.366-12.139 26.403-41.845 39.614-69.502 29.938z" })),
                    React__default['default'].createElement("g", null,
                        React__default['default'].createElement("ellipse", { cx: "216.296", cy: "109.448", rx: "8.787", ry: "10.953" }),
                        React__default['default'].createElement("ellipse", { cx: "178.734", cy: "299.421", rx: "8.787", ry: "10.953" }),
                        React__default['default'].createElement("ellipse", { cx: "310.893", cy: "293.248", rx: "8.787", ry: "10.953" }),
                        React__default['default'].createElement("ellipse", { cx: "297.825", cy: "187.208", rx: "8.787", ry: "10.953" }),
                        React__default['default'].createElement("ellipse", { cx: "187.521", cy: "227.611", rx: "8.787", ry: "10.953" })))))));
};

var Icon$17 = function (props) {
    return (React__default['default'].createElement("svg", __assign({ height: "512pt", viewBox: "-16 0 512 512", width: "512pt", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__default['default'].createElement("path", { d: "m172.480469 160h-120.960938v-32l32-128h56.960938l32 128zm0 0", fill: "#d7dee2" }),
        React__default['default'].createElement("path", { d: "m51.503906 128h-35.503906v96h192v-96zm0 0", fill: "#b0b4b9" }),
        React__default['default'].createElement("path", { d: "m192 512h-160c-17.679688 0-32-14.320312-32-32v-288h224v288c0 17.679688-14.320312 32-32 32zm0 0", fill: "#e76e54" }),
        React__default['default'].createElement("path", { d: "m428.480469 176h-120.960938v-48l32-128h56.960938l32 128zm0 0", fill: "#d7dee2" }),
        React__default['default'].createElement("path", { d: "m307.503906 128h-35.503906v96h192v-96zm0 0", fill: "#b0b4b9" }),
        React__default['default'].createElement("path", { d: "m448 512h-160c-17.679688 0-32-14.320312-32-32v-288h224v288c0 17.679688-14.320312 32-32 32zm0 0", fill: "#fe9d58" }),
        React__default['default'].createElement("g", { fill: "#fff" },
            React__default['default'].createElement("path", { d: "m64 224.800781h32v31.199219h-32zm0 0" }),
            React__default['default'].createElement("path", { d: "m128 224.800781h32v31.199219h-32zm0 0" }),
            React__default['default'].createElement("path", { d: "m320 224.800781h32v31.199219h-32zm0 0" }),
            React__default['default'].createElement("path", { d: "m384 224.800781h32v31.199219h-32zm0 0" })),
        React__default['default'].createElement("path", { d: "m192 480h-160c-17.679688 0-32-14.320312-32-32v32c0 17.679688 14.320312 32 32 32h160c17.679688 0 32-14.320312 32-32v-32c0 17.679688-14.320312 32-32 32zm0 0", fill: "#dd523c" }),
        React__default['default'].createElement("path", { d: "m448 480h-160c-17.679688 0-32-14.320312-32-32v32c0 17.679688 14.320312 32 32 32h160c17.679688 0 32-14.320312 32-32v-32c0 17.679688-14.320312 32-32 32zm0 0", fill: "#f9873a" })));
};

var Icon$18 = function (props) {
    return (React__default['default'].createElement("svg", __assign({ id: "Layer_1", height: "512", viewBox: "0 0 124 124", width: "512", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__default['default'].createElement("path", { d: "m114.778 89.979c-2.752-3.001-5.494-5.011-7.536-6.303l.038-.002-5.207-5.464-9.948 6.73-9.249-6.601-7.571 7.07c-4.141 3.061-7.779 6.987-10.253 11.522-1.291 2.367-2.013 4.981-2.622 7.592-.645 2.762-1.481 5.621-1.481 8.477h63.051c0-8.692-3.396-16.667-9.222-23.021-2.752-3.001 1.672 1.824 0 0z", fill: "#90caf9" }),
        React__default['default'].createElement("path", { d: "m98.568 95.702 8.452-12.301-4.947-5.191-9.948 6.73z", fill: "#64b5f6" }),
        React__default['default'].createElement("path", { d: "m92.125 84.94-9.249-6.601-5.357 5.003 8.494 12.36z", fill: "#64b5f6" }),
        React__default['default'].createElement("path", { d: "m113.646 100.131h-2.633v-2.776c0-1.104-.896-2-2-2s-2 .896-2 2v2.776h-2.634c-1.104 0-2 .896-2 2s.896 2 2 2h2.634v2.776c0 1.104.896 2 2 2s2-.896 2-2v-2.776h2.633c1.104 0 2-.896 2-2s-.896-2-2-2z", fill: "#0d47a1" }),
        React__default['default'].createElement("path", { d: "m109.106 16.328c-1.267-3.221-4.303-5.328-7.675-5.328h-17.913c-3.372 0-6.408 2.107-7.675 5.328l-4.02 17.171 41.322.098z", fill: "#78909c" }),
        React__default['default'].createElement("path", { d: "m113.149 33.613-41.326-.114c-1.034 5.134-.824 10.689-.459 15.321-1.506-2.942-5.929-2.037-5.584 2.587.376 4.43 16.688 21.049 24.154 22.083 1.596.305 3.225.271 4.831.065 7.56-.97 23.997-17.686 24.373-22.116.376-4.656-4.078-5.529-5.552-2.619.664-5.111.571-10.105-.437-15.207z", fill: "#ffb74d" }),
        React__default['default'].createElement("ellipse", { cx: "92.475", cy: "33.615", fill: "#fff", rx: "9.983", ry: "10.094" }),
        React__default['default'].createElement("path", { d: "m95.748 32.069h-1.273v-1.373c0-1.104-.896-2-2-2s-2 .896-2 2v1.373h-1.273c-1.104 0-2 .896-2 2s.896 2 2 2h1.273v1.374c0 1.104.896 2 2 2s2-.896 2-2v-1.374h1.273c1.104 0 2-.896 2-2s-.896-2-2-2z", fill: "#dd2d2d" }),
        React__default['default'].createElement("path", { d: "m47.84 83.17c1.716-.839.035-2.369-.897-2.877-3.049-2.039-2.286-1.396-2.894-1.824-1.996-1.405-4.532-5.57-4.582-6.813.05 1.243 0-2.319 0-2.319h-15.593v2.319c.063 2.058-2.249 5.594-4.304 6.664-2.333 1.215-2.141 1.228-3.368 1.829l.31.516c-.937.517 9.61 13.125 31.328 2.505z", fill: "#ff9800" }),
        React__default['default'].createElement("path", { d: "m63.051 113h-63.051c-.003-2.499.266-10.333 1.671-14.6.463-1.408 2.311-6.705 6.998-11.948 3.97-4.441 8.208-6.866 10.902-8.132 3.09 3.27 7.382 5.248 11.907 5.226h.048c4.746 0 9.056-2.029 12.155-5.285 1.256.7 3.132 1.835 5.23 3.482 2.921 2.293 9.366 7.489 12.451 16.607.755 2.233 1.698 9.929 1.689 14.65z", fill: "#64b5f6" }),
        React__default['default'].createElement("g", { fill: "#ffb74d" },
            React__default['default'].createElement("path", { d: "m8.355 41.6c-3.158 1.583-5.079 4.959-4.117 8.354.913 3.222 3.919 5.423 7.239 5.246l3.145.379-3.111-14.88z" }),
            React__default['default'].createElement("path", { d: "m55.604 41.644c2.589.694 3.912 4.351 2.956 8.168-.957 3.816-3.831 6.347-6.42 5.653l-5.197-.254 6.821-16.092z" }),
            React__default['default'].createElement("path", { d: "m55.133 39.962s-9.556-22.979-27.418-20.477c-13.091 1.833-19.689 20.245-19.689 20.245 1.822 11.175 5.71 19.018 8.487 23.627 4.835 8.025 8.48 9.837 10.629 10.595 1.065.376 5.085 1.603 9.564 0 2.671-.956 5.71-3.025 9.83-10.17 2.713-4.704 6.47-12.611 8.312-23.822z" })),
        React__default['default'].createElement("path", { d: "m11.148 42.79c.7-4.124 1.49-8.65 4.442-11.843 2.558-2.766 5.787-3.424 7.315-3.735 4.936-1.005 9.029.711 10.339 1.202 3.874 1.453 4.165 2.73 7.143 3.632 3.753 1.127 7.062.271 9.725-.731 1.517 6.633 2.464 13.522 1.954 20.315 1.514-3.468 2.522-7.155 2.981-10.912.47-3.842.634-7.71-.266-11.506-1.661-7.01-5.945-13.292-12.696-16.24-2.841-1.241-5.961-1.855-9.06-1.816-12.567-1.328-19.37 6.262-19.37 6.262-4.6 3.357-1.671 8.416-1.671 8.416-1.377 1.237-2.832 2.082-3.355 3.957-.556 1.995-.843 4.081-.842 6.151.002 4.342.964 8.763 2.539 12.797.262-2.437.57-4.464.822-5.949z", fill: "#424242" }),
        React__default['default'].createElement("path", { d: "m20.51 95.035-2.767-1.581-.08-14.156c-1.245.683-2.651 1.563-4.133 2.684l.077 11.415c-2.635 1.347-5.412 2.495-7.036 5.132-1.579 2.565-1.301 5.476-1.301 8.352 0 1.15.925 2.082 2.067 2.082s2.067-.932 2.067-2.082c0-2.022-.4-4.519.769-6.29 1.183-1.792 3.611-2.616 5.455-3.558 1.884 1.076 4.282 2.025 5.137 4.183.664 1.676.313 3.9.313 5.666 0 1.15.925 2.082 2.067 2.082s2.067-.932 2.067-2.082c0-1.441.049-2.889-.005-4.329-.118-3.164-1.974-5.962-4.697-7.518z", fill: "#fff" }),
        React__default['default'].createElement("path", { d: "m49.01 92.189v-10.368c-.032-.025-.068-.054-.099-.078-1.511-1.186-2.902-2.102-4.034-2.786v13.232c-1.972.835-3.364 2.824-3.364 5.141 0 3.067 2.436 5.562 5.431 5.562s5.431-2.495 5.431-5.562c-.001-2.317-1.393-4.307-3.365-5.141zm-2.067 6.539c-.715 0-1.297-.627-1.297-1.399 0-.771.582-1.399 1.297-1.399s1.297.627 1.297 1.399-.582 1.399-1.297 1.399z", fill: "#fff" })));
};

var Icon$19 = function (props) {
    return (React__default['default'].createElement("svg", __assign({ id: "Capa_1", height: "512", viewBox: "0 0 497 497", width: "512", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__default['default'].createElement("path", { d: "m394.167 105v332c23.558 0 42.833-19.275 42.833-42.833v-259.167z", fill: "#e00016" }),
        React__default['default'].createElement("path", { d: "m407 394.167v-289.167l-55.666 30v259.167c0 23.558 19.275 42.833 42.833 42.833 7.058 0 12.833-19.275 12.833-42.833z", fill: "#ff4547" }),
        React__default['default'].createElement("path", { d: "m437 135h-30l-25.667-60 55.667 30z", fill: "#9bfef7" }),
        React__default['default'].createElement("path", { d: "m407 135h-55.667v-30l55.667-30z", fill: "#dbfffc" }),
        React__default['default'].createElement("path", { d: "m437 105h-30l-25.667-90h55.667z", fill: "#ffd959" }),
        React__default['default'].createElement("path", { d: "m351.333 15h55.667v90h-55.667z", fill: "#ffeaa6" }),
        React__default['default'].createElement("path", { d: "m422 0-30 22.5 30 22.5h22.5c4.142 0 7.5-3.358 7.5-7.5v-30c0-4.142-3.358-7.5-7.5-7.5z", fill: "#ffc40f" }),
        React__default['default'].createElement("path", { d: "m336.333 7.5v30c0 4.142 3.358 7.5 7.5 7.5h78.167v-45h-78.167c-4.142 0-7.5 3.358-7.5 7.5z", fill: "#ffd959" }),
        React__default['default'].createElement("path", { d: "m248.5 105v332c23.558 0 42.833-19.275 42.833-42.833v-259.167z", fill: "#e00016" }),
        React__default['default'].createElement("path", { d: "m261.333 394.167v-289.167l-55.666 30v259.167c0 23.558 19.275 42.833 42.833 42.833 7.058 0 12.833-19.275 12.833-42.833z", fill: "#ff4547" }),
        React__default['default'].createElement("path", { d: "m291.333 135h-30l-25.666-60 55.666 30z", fill: "#9bfef7" }),
        React__default['default'].createElement("path", { d: "m261.333 135h-55.666v-30l55.666-30z", fill: "#dbfffc" }),
        React__default['default'].createElement("path", { d: "m291.333 105h-30l-25.666-90h55.666z", fill: "#ccc9fa" }),
        React__default['default'].createElement("path", { d: "m205.667 15h55.667v90h-55.667z", fill: "#dbdeff" }),
        React__default['default'].createElement("path", { d: "m276.333 0-30 22.5 30 22.5h22.5c4.142 0 7.5-3.358 7.5-7.5v-30c0-4.142-3.358-7.5-7.5-7.5z", fill: "#c782ff" }),
        React__default['default'].createElement("path", { d: "m190.667 7.5v30c0 4.142 3.358 7.5 7.5 7.5h78.167v-45h-78.167c-4.143 0-7.5 3.358-7.5 7.5z", fill: "#caa6fd" }),
        React__default['default'].createElement("path", { d: "m102.833 105v332c23.558 0 42.833-19.275 42.833-42.833v-259.167z", fill: "#e00016" }),
        React__default['default'].createElement("path", { d: "m115.666 394.167v-289.167l-55.666 30v259.167c0 23.558 19.275 42.833 42.833 42.833 7.058 0 12.833-19.275 12.833-42.833z", fill: "#ff4547" }),
        React__default['default'].createElement("path", { d: "m145.667 135h-30l-25.667-60 55.667 30z", fill: "#9bfef7" }),
        React__default['default'].createElement("path", { d: "m115.667 135h-55.667v-30l55.667-30z", fill: "#dbfffc" }),
        React__default['default'].createElement("path", { d: "m145.667 105h-30l-25.667-90h55.667z", fill: "#4ba6a7" }),
        React__default['default'].createElement("path", { d: "m60 15h55.667v90h-55.667z", fill: "#59d1cc" }),
        React__default['default'].createElement("path", { d: "m130.667 0-30 22.5 30 22.5h22.5c4.142 0 7.5-3.358 7.5-7.5v-30c0-4.142-3.358-7.5-7.5-7.5z", fill: "#3e7b81" }),
        React__default['default'].createElement("path", { d: "m45 7.5v30c0 4.142 3.358 7.5 7.5 7.5h78.167v-45h-78.167c-4.142 0-7.5 3.358-7.5 7.5z", fill: "#4ba6a7" }),
        React__default['default'].createElement("path", { d: "m30 278.5h452l-15-60h-459.5c-4.142 0-7.5 3.358-7.5 7.5v263.5c0 4.142 3.358 7.5 7.5 7.5h459.5l15-30h-452z", fill: "#9bfef7" }),
        React__default['default'].createElement("path", { d: "m467 218.5v278.5h22.5c4.142 0 7.5-3.358 7.5-7.5v-263.5c0-4.142-3.358-7.5-7.5-7.5z", fill: "#4ef5e9" })));
};

var Icon$1a = function (props) {
    return (React__default['default'].createElement("svg", __assign({ id: "Capa_1", height: "512", viewBox: "0 0 513.673 513.673", width: "512", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("g", { fill: "#617881" },
                React__default['default'].createElement("path", { d: "m97.322 512.836h-37.41c-1.679 0-3.041-1.361-3.041-3.041v-39.138h43.492v39.138c0 1.68-1.361 3.041-3.041 3.041z" }),
                React__default['default'].createElement("path", { d: "m273.179 512.836h-37.41c-1.679 0-3.041-1.361-3.041-3.041v-39.138h43.492v39.138c0 1.68-1.362 3.041-3.041 3.041z" }),
                React__default['default'].createElement("path", { d: "m470.782 512.836h-37.41c-1.679 0-3.041-1.361-3.041-3.041v-39.138h43.492v39.138c0 1.68-1.362 3.041-3.041 3.041z" })),
            React__default['default'].createElement("path", { d: "m228.721 480.993h250.283c19.147 0 34.669-15.522 34.669-34.669v-410.818c0-19.147-15.522-34.669-34.669-34.669h-159.627z", fill: "#d0e2e7" }),
            React__default['default'].createElement("path", { d: "m1.961 207.597c.03.081.06.162.09.243 6.907 18.408 7.901 38.484 4.248 57.802-3.353 17.734-6.243 40.349-6.243 66.673v91.862c0 31.378 25.437 56.816 56.816 56.816h171.849c31.378 0 56.816-25.437 56.816-56.816v-91.862c0-31.392 4.115-62.648 12.24-92.97l52.958-197.644c5.525-20.618-10.012-40.866-31.357-40.866h-41.876z", fill: "#dfeaef" }),
            React__default['default'].createElement("path", { d: "m225.883 445.095h-166.175c-13.12 0-23.755-10.636-23.755-23.755v-132.732c0-13.12 10.636-23.755 23.755-23.755h166.175c13.12 0 23.755 10.636 23.755 23.755v132.732c.001 13.12-10.635 23.755-23.755 23.755z", fill: "#f1f4f6" }),
            React__default['default'].createElement("path", { d: "m35.953 337.608h213.686v-15.504h-213.686z", fill: "#d0e2e7" }),
            React__default['default'].createElement("g", null,
                React__default['default'].createElement("path", { d: "m188.46 306.299h-91.328c-4.281 0-7.752-3.47-7.752-7.752s3.471-7.752 7.752-7.752h91.329c4.281 0 7.752 3.47 7.752 7.752s-3.472 7.752-7.753 7.752z", fill: "#dfeaef" })),
            React__default['default'].createElement("path", { d: "m277.501.837h-201.294c-14.692 0-27.552 9.868-31.354 24.059l-43.729 163.197c-5.524 20.616 10.011 40.861 31.354 40.861h201.294c14.692 0 27.552-9.868 31.354-24.059l43.729-163.198c5.524-20.615-10.011-40.86-31.354-40.86z", fill: "#407093" }),
            React__default['default'].createElement("path", { d: "m38.133 188.669 40.019-149.351c.408-1.524 1.789-2.583 3.367-2.583h186.96c2.292 0 3.96 2.174 3.367 4.388l-40.019 149.352c-.408 1.524-1.789 2.583-3.367 2.583h-186.96c-2.292-.001-3.96-2.175-3.367-4.389z", fill: "#b1e4f9" }),
            React__default['default'].createElement("path", { d: "m268.478 36.735h-42.338l-25.031 93.417c-6.675 24.912-29.25 42.234-55.041 42.234h-103.572l-4.363 16.283c-.593 2.214 1.075 4.388 3.367 4.388h186.96c1.577 0 2.958-1.06 3.367-2.583l40.019-149.352c.592-2.214-1.076-4.387-3.368-4.387z", fill: "#90d8f9" }),
            React__default['default'].createElement("path", { d: "m119.133 158.503c-1.984 0-3.968-.757-5.481-2.27-3.027-3.028-3.027-7.935 0-10.963l71.711-71.711c3.027-3.026 7.935-3.026 10.962 0 3.027 3.028 3.027 7.935 0 10.963l-71.711 71.711c-1.513 1.513-3.497 2.27-5.481 2.27zm25.899-74.514c0 12.671-10.308 22.979-22.979 22.979s-22.979-10.308-22.979-22.979 10.308-22.979 22.979-22.979 22.979 10.308 22.979 22.979zm-15.503 0c0-4.122-3.353-7.476-7.476-7.476s-7.476 3.354-7.476 7.476 3.354 7.476 7.476 7.476 7.476-3.354 7.476-7.476zm56.367 40.863c12.671 0 22.979 10.308 22.979 22.979s-10.308 22.979-22.979 22.979-22.979-10.308-22.979-22.979 10.309-22.979 22.979-22.979zm0 15.504c-4.122 0-7.476 3.354-7.476 7.476s3.353 7.476 7.476 7.476c4.122 0 7.476-3.354 7.476-7.476s-3.354-7.476-7.476-7.476z", fill: "#f4fbff" }),
            React__default['default'].createElement("path", { d: "m193.347 147.219c.016.202.025.406.025.612 0 3.816-2.874 6.973-6.571 7.421-4.304 4.396-9.298 8.076-14.782 10.883 3.858 2.932 8.668 4.675 13.877 4.675 12.671 0 22.979-10.308 22.979-22.979 0-6.892-3.05-13.085-7.871-17.3-1.669 6.066-4.283 11.676-7.657 16.688z", fill: "#e4f6ff" }))));
};
...
var socials = [
    {
        ...
        items: [
            {
                label: "English",
                href: "https://t.me/OmicronFinance",
            },
        ],
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/OmicronDefi",
    },
];
var MENU_HEIGHT = 64;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#5a3a22", textDisabled: "#BDC2C4", textSubtle: "#5a3a22", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#e54342", background: "#343135", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#27262c", gradients: {
